...
import ParaguasRedFinanciadaPage, { generateMetadata } from "./page";
...
async function renderPage(slug = "diputacion-demo", role = "analista") {
  ...
  const element = await ParaguasRedFinanciadaPage({ params: Promise.resolve({ slug }) });
  return render(element);
}

describe("ParaguasRedFinanciadaPage", () => {
  it("expone el título de la página vía generateMetadata", async () => {
    expect((await generateMetadata()).title).toBe("Red financiada");
  });
  ...
  it("sin sesión redirige a /login", async () => {
    ...
    await expect(
      ParaguasRedFinanciadaPage({ params: Promise.resolve({ slug: "diputacion-demo" }) }),
  ...
  it("sin membresía en esa entidad paraguas redirige a /", async () => {
    ...
    await expect(
      ParaguasRedFinanciadaPage({ params: Promise.resolve({ slug: "otra-diputacion" }) }),
