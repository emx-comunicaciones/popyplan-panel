...
import { ComunidadesPanel } from "@/components/entidad/ComunidadesPanel";
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("pages.entidad.comunidades");
  return { title: t("title") };
}

export default async function EntidadComunidadesPage({
  params,
}: {
